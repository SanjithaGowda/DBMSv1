...
if (isset($_SESSION['pono']))
{
    ...
    $query="SELECT * FROM orders WHERE pono=$pono";
    ...
    $query="SELECT * FROM ordered_pdts1 WHERE pono=$pono";
    $result = mysqli_query($conn,$query);
...
<br>
<h1 style ="text-align:  center; font-size: 22px">invoice number :<?php echo $_SESSION['pono']; ?> <br> company name :<?php echo $cname; ?>  </h1>
    <?php
    ...
    <br>
    <form action="empupdatestatusfinal.php" method="post" >          
        <input style="align:center; margin-right:45%" type="submit" value="Order finished"  name="finalsubmit" >
    </form>
...
{
    //echo "entered";
    $query = "UPDATE orders SET finished='1' where pono = '$pono' ";
    $result = mysqli_query($conn,$query);
    if ($result)
    {
