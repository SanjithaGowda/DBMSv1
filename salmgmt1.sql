...
create table employees(name varchar(100) not null, empid int(20) primary key, uname varchar(20) unique, pwd varchar(100), bsal float(10,2), ot int, image varchar(1000));
